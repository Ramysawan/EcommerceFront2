      ...
      <Card className=" card-testimonial card-plain">
        ...
        <CardBody>
          <h5 className=" card-description">
            "My old phone died and i needed a new phone. A friend told me about
            phonehub so i dedcided to give it a try. Bought the phone with all
            its accessories and never been more satisfied."
          </h5>
          <CardFooter>
            <CardTitle tag="h4">Patrick Badran</CardTitle>
            <h6 className=" card-category">Engineer</h6>
  ...
  },
  {
    content: (
      <Card className=" card-testimonial card-plain">
        ...
        <CardBody>
          <h5 className=" card-description">
            "Love the apple watch accessories, bands are provided in all colors
            and are good quality"
          </h5>
          <CardFooter>
            <CardTitle tag="h4">Rabih Shoujaa</CardTitle>
            <h6 className=" card-category">Student</h6>
            <div className=" card-stars">
              <i aria-hidden={true} className=" fa fa-star mr-1"></i>
              <i aria-hidden={true} className=" fa fa-star mr-1"></i>
              <i aria-hidden={true} className=" fa fa-star mr-1"></i>
  ...
  },
  {
    content: (
      <Card className=" card-testimonial card-plain">
        ...
        <CardBody>
          <h5 className=" card-description">
            "Bought airpods Pro with black airpods cover, now im rocking these
            in public!"
          </h5>
          <CardFooter>
            <CardTitle tag="h4">Ahmad Arrar</CardTitle>
        ...
        <Container fluid>
          <Row>
            <Col className="ml-auto mr-auto text-center" md="8">
              <h2 className="title">Trusted by +3000 People</h2>
              <h5 className="description">
                Our products including phones, laptops and accessories were
                bought by <b>+300 customers</b> in over <b>4 countries</b>. This
                is what some of them think:
              </h5>
            </Col>
          </Row>
          <Row>
